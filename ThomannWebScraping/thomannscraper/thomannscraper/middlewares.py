...
class ThomannscraperSpiderMiddleware:
...
class ThomannscraperDownloaderMiddleware:
    # Not all methods need to be defined. If a method is not defined,
...
def should_abort_request(request):
    ...
    if resource_type in ["image", "stylesheet", "font", "media"]:
        return True
    if any(domain in request.url for domain in ["google", "facebook", "analytics", "doubleclick"]):
        return True
    return False
