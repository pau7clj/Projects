-- Proiect2: Exploratory Data Analysis
...
SELECT *
FROM layoffs_staging2
WHERE percentage_laid_off = 1; -- astia is cooked care o dat afara pe toata lumea
...
-- luam si anul si luna ca sa aiba sens
...
-- Vrem sa vedem la fiecare companie pe an un rolling total
SELECT company, SUM(total_laid_off)
FROM layoffs_staging2
GROUP BY company
ORDER BY 2 DESC; 
...
-- vrem sa facem un ranking pe ani
